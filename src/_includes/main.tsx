...
export default function MainLayout({
  ...
  return (
    <html>
      ...
      <body className="min-h-screen bg-linear-to-br from-blue-500 via-purple-500 to-pink-500 p-4 md:p-8">
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden backdrop-blur-sm">
          <header className="bg-linear-to-r from-green-500 to-blue-600 text-white p-6 text-center">
